...
import { treeQueueService } from "./tree-queue-service";
import { walletService } from "./wallet-service";
import { arHistoryService } from "./ar-history-service";
import { RegisterUser } from "@/validation";
import { sql } from "drizzle-orm";
import { salesRewardService } from "./sale-rewards-service";
...
export default class UserService {
  ...
  async setTokenCookie(c: Context, id: UserId) {
